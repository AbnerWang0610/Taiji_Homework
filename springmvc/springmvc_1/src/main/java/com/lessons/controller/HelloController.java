...
public class HelloController {
	...
	@PostMapping("/json")
	@ResponseBody
	public User json(@RequestBody User user) throws InterruptedException {
		/*
		 * User user = new user(); user.setAge(12); user.setName("哇哈哈");
		 */
		user.setAge(user.getAge() + 222);
		System.out.println("222年后我是" + user.getAge());
		return user;
	}
